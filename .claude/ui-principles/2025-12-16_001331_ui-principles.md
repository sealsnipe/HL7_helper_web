...
|-----------|-------|
| **Version** | 1.1.0 |
| **Created** | 2025-12-16T00:13:31 |
| **Status** | Official Reference |
| **Maintained By** | @ux-specialist |
...
| Role | Responsibility |
|------|----------------|
| **@ux-specialist** | Maintain document, verify compliance, add new principles, identify patterns, suggest improvements, flag inconsistencies |
| **@developer** | Implement to principles, flag deviations with justification |
| **@code-reviewer** | Verify principle compliance in code reviews |
...
| 1.1.0 | 2025-12-16 | Agent consolidation: @ux-analyst + @ux-designer → @ux-specialist, @reviewer → @code-reviewer |

---

**Document End**

This document is the authoritative reference for UI consistency in the HL7 Helper Web project. When in doubt, consult this document. If a pattern is not documented here, it should be added by @ux-specialist before becoming standard practice.
